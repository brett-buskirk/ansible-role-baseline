...
### Added
- Initial `baseline` Ansible role — a host-hardening baseline for fresh Ubuntu servers, built on
...
- Config-driven via `defaults/main.yml`; every block is opt-out. Galaxy metadata targeting Ubuntu,
