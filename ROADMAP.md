...
`ansible-role-baseline` is a single-role host baseline for fresh Ubuntu servers — SSH hardening, a UFW
...
- [ ] Broaden beyond Ubuntu — Debian is close; parameterize the few distro assumptions.
